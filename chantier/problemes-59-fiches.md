# Problèmes : Avoir 20 ans en France, l'entrée dans la vie comme parcours d'obstacles

### P1. Le logement étudiant introuvable : caution, garants, CROUS saturé, Visale orpheline
...
### P2. Le permis de conduire : 1 500-2 000 euros, emploi quasi-impossible sans
...
### P4. Premier CDI à 27-28 ans : intérim généralisé, CDD à répétition, insertion sinistrée
...
### P6. RSA interdit aux moins de 25 ans : exception française entre tous les voisins
...
### P8. Décohabitation la plus tardive d'Europe du Nord : logement + assurance-famille
...
### P9. Épargne et propriété devenues héréditaires : sans donations, accès à zéro
...
### P10. Service national universel vs vrais dispositifs d'émancipation : un an de caserne ou trois ans de trajectoire
