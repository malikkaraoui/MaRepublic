# Axe 4 : Souveraineté · Panorama de fiches-mesures

> **Statut global : BROUILLON, matière première non validée.**
> Ce fichier est une base à trancher ensemble (ping-pong). Rien ici n'est une position du mouvement tant que tu ne l'as pas validée.
>
> **Méthode.** Une fiche = une mesure qui **existe déjà ailleurs** (on n'invente pas, on importe/adapte). Tri en une passe : ✅ garde · ✂️ jette · ✏️ modifie.
>
> **⚠️ Sur les chiffres.** Les ordres de grandeur ci-dessous servent à décider vite. Ceux marqués « à confirmer » seront sourcés proprement **au moment où on fige** la fiche, on ne source pas ce qui sera jeté.
>
> **Légende statut :** ⬜ brouillon · 🟩 validé · 🟥 rejeté · 🟧 à retravailler

---

## Pilier A : Énergie

### A1. Nucléaire « en série » plutôt qu'en prototype
- **Problème France :** l'EPR de Flamanville = ~12 ans de retard et un coût multiplié (prototype unique, perte de la culture de série).
...
### A2. Norme « Top Runner » sur l'efficacité énergétique
- **Problème France :** normes d'efficacité fixées par le bas, qui traînent derrière la technologie.
...
### B1. Sécurité alimentaire inscrite dans la Constitution
- **Problème France :** dépendance croissante aux importations sur plusieurs filières, pas d'objectif contraignant.
...
### B2. Contrats de filière longue durée (prix plancher)
- **Problème France :** les agriculteurs subissent les prix ; guerre des marges avec la grande distribution.
...
- **Problème France / UE :** **Chat Control** repasse au Parlement européen à l'été 2026, quasi identique à la version rejetée, scan généralisé des messages (client-side scanning) qui casse le chiffrement de bout en bout. Re-déposé en « saison morte » pour passer discrètement.
...
### C2. Échange de données publiques décentralisé (modèle X-Road)
- **Problème France :** données publiques en silos, ressaisies multiples, pas de contrôle citoyen sur qui accède à quoi.
...
### C3. Hébergement souverain obligatoire des données sensibles
- **Problème France :** données publiques/santé souvent hébergées sur des clouds soumis au droit extra-européen (Cloud Act US).
...
### C4. IA « sur un plateau » pour préparer la décision citoyenne
- **Problème France :** masse de données ingérable par les élus ; débats sans synthèse neutre ; le citoyen vote sans dossier clair.
...
### D1. Aides publiques conditionnées + remboursement si délocalisation
- **Problème France :** des entreprises touchent des aides puis délocalisent sans contrepartie.
...
### D2. Stocks stratégiques de métaux critiques
- **Problème France :** dépendance quasi totale à la Chine sur terres rares / métaux de la transition et du numérique.
