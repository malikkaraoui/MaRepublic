# Problèmes : Jeunesse, la France qui commence dans le rouge

> BROUILLON non validé : documenté, chiffré, simulé.

---

### P1. Le permis à 1 800 euros : un mur infranchissable pour travailler
...
### P2. Le garant impossible : propriétaires requis pour louer
...
### P3. Les stages à 4,50 euros de l'heure : formation ou exploitation ?
...
### P4. Le premier CDI à 27 ans : l'intérim comme prison du marché
...
### P8. L'APL jeune actif raboté dès le premier salaire
...
### P9. La mobilité étudiante : partir étudier = luxe (6 % en Crous)
...
### P10. Voter à 18 ans mais compter pour rien : le poids électoral confisqué par la démographie
